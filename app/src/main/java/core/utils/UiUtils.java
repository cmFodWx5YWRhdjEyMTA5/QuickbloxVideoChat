...
public class UiUtils {
    ...
    public static int getCircleColor(@IntRange(from = RANDOM_COLOR_START_RANGE, to = RANDOM_COLOR_END_RANGE)
        ...
        int colorId = CoreApp.getInstance().getResources()
                .getIdentifier("holo_green_dark", "color", CoreApp.getInstance().getPackageName());
        Log.d("UiUtils", "getColorId: "+colorId);
        return ResourceUtils.getColor(android.R.color.holo_green_dark);
    }
}
